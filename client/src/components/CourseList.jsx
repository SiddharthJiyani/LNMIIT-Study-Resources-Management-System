    ...
    return (
        <div className="flex min-h-screen w-full flex-col bg-zinc-100 dark:bg-zinc-900">
            ...
            <div className="flex flex-1">
                <aside className="hidden h-screen border-r bg-white dark:bg-zinc-950 md:block md:w-1/4 lg:w-1/5">
                    <SideBar />
                </aside>
                                    ...
                                    {filteredResources.length > 0 ? (
                                        filteredResources.map((resource, index) => (
                                            ...
                                            >
                                                ...
                                                <td className="py-2 px-2 sm:px-4 border-b dark:border-zinc-800">{resource.ratings || 'N/A'}</td>
